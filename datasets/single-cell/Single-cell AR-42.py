...
source_data = pd.read_csv('/data/sr/AR-42.csv')
...
# pd.DataFrame(tlabel_).to_csv('AR-42_tlable.csv')
# pd.DataFrame(tpred_).to_csv('AR-42_tprde.csv')
# pd.DataFrame(total_feature).to_csv('AR-42_features.csv')
...
plt.ylim(0, 1)
# 添加标题和轴标签
plt.title('AR-42 with LIP AUC Scores over Epochs')
plt.xlabel('Epoch')
