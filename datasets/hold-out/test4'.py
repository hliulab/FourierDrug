...
source_data = pd.read_csv('/data/sr/output_Docetaxel.csv')
target_data = pd.read_csv('/data/sr/output_DU145_tpm_hg38_new.csv')
...
x_1 = source_data[source_data['label'] == 1].iloc[:, 6:].values
x_2 = source_data[source_data['label'] == 2].iloc[:, 6:].values
x_3 = source_data[source_data['label'] == 3].iloc[:, 6:].values
x_4 = source_data[source_data['label'] == 4].iloc[:, 6:].values
x_5 = source_data[source_data['label'] == 5].iloc[:, 6:].values
x_6 = source_data[source_data['label'] == 6].iloc[:, 6:].values
x_7 = source_data[source_data['label'] == 7].iloc[:, 6:].values
x_8 = source_data[source_data['label'] == 8].iloc[:, 6:].values
x_9 = source_data[source_data['label'] == 9].iloc[:, 6:].values
x_10 = source_data[source_data['label'] == 10].iloc[:, 6:].values
x_11 = source_data[source_data['label'] == 11].iloc[:, 6:].values
x_12 = source_data[source_data['label'] == 12].iloc[:, 6:].values
x_13 = source_data[source_data['label'] == 13].iloc[:, 6:].values
x_14 = source_data[source_data['label'] == 14].iloc[:, 6:].values
x_15 = source_data[source_data['label'] == 15].iloc[:, 6:].values
x_16 = source_data[source_data['label'] == 16].iloc[:, 6:].values
x_17 = source_data[source_data['label'] == 17].iloc[:, 6:].values
x_18 = source_data[source_data['label'] == 18].iloc[:, 6:].values
t_1 = target_data[target_data['label'] == 18].iloc[:, 3:].values
r_1 = source_data[source_data['label'] == 1].iloc[:, 4].values
r_2 = source_data[source_data['label'] == 2].iloc[:, 4].values
r_3 = source_data[source_data['label'] == 3].iloc[:, 4].values
r_4 = source_data[source_data['label'] == 4].iloc[:, 4].values
r_5 = source_data[source_data['label'] == 5].iloc[:, 4].values
r_6 = source_data[source_data['label'] == 6].iloc[:, 4].values
r_7 = source_data[source_data['label'] == 7].iloc[:, 4].values
r_8 = source_data[source_data['label'] == 8].iloc[:, 4].values
r_9 = source_data[source_data['label'] == 9].iloc[:, 4].values
r_10 = source_data[source_data['label'] == 10].iloc[:, 4].values
r_11 = source_data[source_data['label'] == 11].iloc[:, 4].values
r_12 = source_data[source_data['label'] == 12].iloc[:, 4].values
r_13 = source_data[source_data['label'] == 13].iloc[:, 4].values
r_14 = source_data[source_data['label'] == 14].iloc[:, 4].values
r_15 = source_data[source_data['label'] == 15].iloc[:, 4].values
r_16 = source_data[source_data['label'] == 16].iloc[:, 4].values
r_17 = source_data[source_data['label'] == 17].iloc[:, 4].values
r_18 = source_data[source_data['label'] == 18].iloc[:, 4].values
t_r = target_data[target_data['label'] == 18].iloc[:, 2].values
...
zeros_tensor = torch.zeros((target_data[target_data['label'] == 11].shape[0], 11))
zeros_tensor[:, 10] = 1
x[f'x{12}_label'] = zeros_tensor
# print(x['x3_label'])
# 将列表中的张量连接起来，沿着列的方向
# print(x['x1_label'])
...
l2 = torch.cat((x['x12_label'],), dim=0)
...
model = Model(s1.shape[1], 1024,760).to(device)
