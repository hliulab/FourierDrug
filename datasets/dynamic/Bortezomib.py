...
source_data = pd.read_csv('/data/sr/supplement/Bortezomib_source1.csv')
...
x_1 = source_data[source_data['Label'] == 1].iloc[:, 4:].values
x_2 = source_data[source_data['Label'] == 2].iloc[:, 4:].values
x_3 = source_data[source_data['Label'] == 3].iloc[:, 4:].values
x_4 = source_data[source_data['Label'] == 4].iloc[:, 4:].values
x_5 = source_data[source_data['Label'] == 5].iloc[:, 4:].values
x_6 = source_data[source_data['Label'] == 6].iloc[:, 4:].values
x_7 = source_data[source_data['Label'] == 7].iloc[:, 4:].values
x_8 = source_data[source_data['Label'] == 8].iloc[:, 4:].values
x_9 = source_data[source_data['Label'] == 9].iloc[:, 4:].values
x_10 = source_data[source_data['Label'] == 10].iloc[:, 4:].values
x_11 = source_data[source_data['Label'] == 11].iloc[:, 4:].values
x_12 = source_data[source_data['Label'] == 12].iloc[:, 4:].values
x_13 = source_data[source_data['Label'] == 13].iloc[:, 4:].values
x_14 = source_data[source_data['Label'] == 14].iloc[:, 4:].values
x_15 = source_data[source_data['Label'] == 15].iloc[:, 4:].values
x_16 = source_data[source_data['Label'] == 16].iloc[:, 4:].values
x_17 = source_data[source_data['Label'] == 17].iloc[:, 4:].values
x_18 = source_data[source_data['Label'] == 18].iloc[:, 4:].values
x_19 = source_data[source_data['Label'] == 19].iloc[:, 4:].values
x_20 = source_data[source_data['Label'] == 20].iloc[:, 4:].values
x_21 = source_data[source_data['Label'] == 21].iloc[:, 4:].values
x_22 = source_data[source_data['Label'] == 22].iloc[:, 4:].values
# x_21 = target_data[target_data['Label'] == 22].iloc[:, 3:].values
# x_22 = target_data[target_data['Label'] == 25].iloc[:, 3:].values
...
r_22 = source_data[source_data['Label'] == 22].iloc[:, 1].values
# r_21 = target_data[target_data['Label'] == 22].iloc[:, 1].values
# r_22 = target_data[target_data['Label'] == 25].iloc[:, 1].values
...
#     threshold = 0.5
#     tpred_1 = (tpred_ >= threshold).astype(int)
#     tauc = accuracy_score(tlabel_, tpred_1)
#     if tauc > best:
#         best = tauc
#         torch.save(model.state_dict(), '/data/sr/Bortezomib_0.pth')
#         pd.DataFrame(tlabel_).to_csv('/data/sr/supplement/Bortezomib_tlable0.csv')
#         pd.DataFrame(tpred_).to_csv('/data/sr/supplement/Bortezomib_tprde0.csv')
#         total_feature = total_feature.detach().cpu().numpy()
#         pd.DataFrame(total_feature).to_csv('/data/sr/supplement/Bortezomib_features0.csv')
#     print(tauc)
