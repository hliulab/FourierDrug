...
source_data = pd.read_csv('/data/sr/Paclitaxel_cell lines.csv')
target_data = pd.read_csv('/data/sr/Paclitaxel_tp3k.csv')
...
pd.DataFrame(tlabel_).to_csv('Paclitaxel_tlable.csv')
pd.DataFrame(tpred_).to_csv('Paclitaxel_tprde.csv')
pd.DataFrame(total_feature).to_csv('Paclitaxel_features.csv')
