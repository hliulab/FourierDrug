...
source_data = pd.read_csv('/data/sr/Sorafenib cell line.csv')
target_data = pd.read_csv('/data/sr/Sorafenib_patients.csv')
...
pd.DataFrame(tlabel_).to_csv('Sorafenib_tlable.csv')
pd.DataFrame(tpred_).to_csv('Sorafenib_tprde.csv')
pd.DataFrame(total_feature).to_csv('Sorafenib_features.csv')
